...
int main() {
  ...
  assert(trade.header.kind == trading::core::EventKind::Trade);
  ...
  assert(trade.header.exchange_ts_ns == 1672515782135000000ULL);
  assert(trade.trade_id == 12345);
  assert(trade.price == 2535190000LL);
  assert(trade.quantity == 3121000000LL);
  assert(trade.aggressor_side == trading::core::AggressorSide::Sell);
  ...
  assert(trade.aggressor_side == trading::core::AggressorSide::Buy);
  ...
  assert(trade.header.exchange_ts_ns == 1672515782137000000ULL);
