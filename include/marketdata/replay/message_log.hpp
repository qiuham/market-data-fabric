...
make_message_log_frame_header(const md::feed::MessageEnvelope &envelope,
...
inline md::feed::MessageEnvelope
to_message_envelope(const MessageLogFrameHeader &header) noexcept {
  md::feed::MessageEnvelope envelope{};
  envelope.payload_kind =
      static_cast<md::feed::PayloadKind>(header.payload_kind);
  envelope.payload_encoding =
      static_cast<md::feed::PayloadEncoding>(header.payload_encoding);
  envelope.protocol = static_cast<md::feed::TransportProtocol>(header.protocol);
  envelope.compression = static_cast<md::feed::Compression>(header.compression);
...
public:
  ...
  MessageLogAppendResult append(const md::feed::MessageEnvelope &envelope,
...
struct MessageLogRecord {
  ...
  [[nodiscard]] md::feed::MessageEnvelope envelope() const noexcept {
