...
[[nodiscard]] inline md::mappers::MapResult map(
  ...
  if (view.kind == OrderKind::AddLimit) {
    ...
    return {md::mappers::MapStatus::Unsupported, false};
  }
  out = event;
  return {md::mappers::MapStatus::MappedDiagnostic, false};
}
...
[[nodiscard]] inline md::mappers::MapResult map(
  ...
  out = event;
  return {md::mappers::MapStatus::Mapped, true};
}
